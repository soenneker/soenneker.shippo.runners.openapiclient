...
using Soenneker.Shippo.Runners.OpenApiClient.Utils.Abstract;
...
namespace Soenneker.Shippo.Runners.OpenApiClient.Utils;
...
public sealed class FileOperationsUtil : IFileOperationsUtil
{
    ...
    public async ValueTask Process(CancellationToken cancellationToken = default)
    {
        ...
        string openApiDocumentUrl = _configuration["Shippo:ClientGenerationUrl"] ?? "https://docs.goshippo.com/spec/shippoapi/public-api.yaml";
        ...
        await _processUtil.Start("kiota", gitDirectory, $"kiota generate -l CSharp -d \"{filePath}\" -o src/{Constants.Library} -c ShippoOpenApiClient -n {Constants.Library}",
